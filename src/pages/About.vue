	        ...
	        <div class="col-md-6">
	            ...
	            <div class="panel panel-primary">
	                ...
	                <div class="panel-body">
	                    ...
	                    <ul>
	                        <li><a target="_blank" rel="noopener" href="http://danb.me"><i class="fa fa-home"></i> &nbsp;&nbsp;danb.me</a></li>
	                        <li><a target="_blank" rel="noopener" href="mailto:ssd.dan.brown@googlemail.com"><i class="fa fa-envelope"></i> &nbsp;&nbsp;ssddanbrown@googlemail.com</a></li>
	                        <li><a href="https://github.com/ssddanbrown" target="_blank" rel="noopener"><i class="fa fa-github"></i> &nbsp;&nbsp;Github</a></li>
	                        <li><a href="https://twitter.com/ssddanbrown" target="_blank" rel="noopener"><i class="fa fa-twitter"></i> &nbsp;&nbsp;Twitter</a></li>
	                        <li><a href="http://uk.linkedin.com/in/danjamesbrown" target="_blank" rel="noopener"><i class="fa fa-linkedin"></i>  &nbsp;&nbsp;LinkedIn</a></li>
	                        <li><a href="https://plus.google.com/102972469186357098848/about" target="_blank" rel="noopener"><i class="fa fa-google-plus"></i> &nbsp;&nbsp;Google+</a></li>
	                    </ul>
	                </div>
	            </div>
	        ...
	        <div class="col-md-6">
	            <div class="panel panel-primary">
	                ...
	                <div class="panel-body">
	                    ...
	                    <ul>
	                        <li>Host: <a href="https://www.digitalocean.com/?refcode=3e6ce576b856" target="_blank" rel="noopener">Digital Ocean</a></li>
	                        <li>OS: <a href="http://www.ubuntu.com/" target="_blank" rel="noopener">Ubuntu 16.04</a></li>
	                        <li>Server Stack: <a target="_blank" rel="noopener" href="http://nginx.org/">NGINX</a>
	                    ...
	                    <a class="btn btn-default" target="_blank" rel="noopener" href="https://github.com/ssddanbrown/iwanttolearn.io"><i class="fa fa-lg fa-github"></i> View On Github</a>
	                    <br/>
	                </div>
	            </div>
	        </div>
